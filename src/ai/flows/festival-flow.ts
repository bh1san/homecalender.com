...
const festivalPrompt = ai.definePrompt({
  ...
  prompt: `You are a cultural expert. Generate a list of the 7 most important or popular festivals for {{country}}. For each festival, provide its name, typical date or date range, and a brief, engaging description.`,
});
